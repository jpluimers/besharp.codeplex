...
type
  ///	<summary>
  ///	  Implements IStringListWrapper by encapsulating a TStringList.
  ///	</summary>
  ///	<remarks>
  ///	  Can probably be split into a TBaseStringsWrapper (that has a ll the
  ///	  logic) and a TStringListWrapper (that only creates the TStringList
  ///	  instance).
  ///	</remarks>
  // TODO ##jwp separate into two classes.
