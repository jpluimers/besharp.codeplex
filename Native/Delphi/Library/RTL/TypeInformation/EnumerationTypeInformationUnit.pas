...
unit EnumerationTypeInformationUnit;
...
function GetEnumerationNameAndOrdValue(const TypeInfo: PTypeInfo; const Value: Integer): string; overload;
...
function GetEnumerationCsvNameList(const TypeInfo: PTypeInfo): string; overload;
...
function GetEnumerationNameAndOrdValue(const TypeInfo: PTypeInfo; const Value: Integer): string;
begin
...
function GetEnumerationIsNotSubRange(const TypeInfo: PTypeInfo): Boolean;
var
  TypeTypeData: PTypeData;
begin
  TypeTypeData := GetTypeData(TypeInfo);
...
function GetEnumUnitName(const TypeInfo: PTypeInfo): string;
var
  TypeTypeData: PTypeData;
...
begin
  ...
  begin
    ...
    if GetEnumerationIsNotSubRange(TypeInfo) then
...
function GetEnumerationCsvNameList(const TypeInfo: PTypeInfo): string;
var
  TypeTypeData: PTypeData;
  ValueIndex: Integer;
  NameList: PShortString;
